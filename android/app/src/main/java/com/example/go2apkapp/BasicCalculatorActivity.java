...
public class BasicCalculatorActivity extends Activity implements Go2ApkActivity {
    ...
    private View createAppView() {
        ...
        view2.setOnClickListener(v -> {
            NativeBridge.sendEvent("btn_back_onclick");
        });
        this.btn_back = view2;
        view1.addView(view2);
        ...
        view4.setText(android.text.Html.fromHtml("Advanced Mode", android.text.Html.FROM_HTML_MODE_COMPACT));
        ...
        view6.setText(android.text.Html.fromHtml("C", android.text.Html.FROM_HTML_MODE_COMPACT));
        ...
        view6.setBackgroundColor(Color.parseColor("#F38BA8"));
        ...
        view9.setText(android.text.Html.fromHtml("/", android.text.Html.FROM_HTML_MODE_COMPACT));
        ...
        view9.setBackgroundColor(Color.parseColor("#F9E2AF"));
        ...
        view11.setText(android.text.Html.fromHtml("7", android.text.Html.FROM_HTML_MODE_COMPACT));
        ...
        view12.setText(android.text.Html.fromHtml("8", android.text.Html.FROM_HTML_MODE_COMPACT));
        ...
        view13.setText(android.text.Html.fromHtml("9", android.text.Html.FROM_HTML_MODE_COMPACT));
        ...
        view13.setBackgroundColor(Color.parseColor("#313244"));
        view13.setTextSize(28);
        view13.setTextColor(Color.parseColor("#CDD6F4"));
        ...
        view16.setText(android.text.Html.fromHtml("4", android.text.Html.FROM_HTML_MODE_COMPACT));
        ...
        view17.setText(android.text.Html.fromHtml("5", android.text.Html.FROM_HTML_MODE_COMPACT));
        ...
        view18.setText(android.text.Html.fromHtml("6", android.text.Html.FROM_HTML_MODE_COMPACT));
        ...
        view21.setText(android.text.Html.fromHtml("1", android.text.Html.FROM_HTML_MODE_COMPACT));
        ...
        view22.setText(android.text.Html.fromHtml("2", android.text.Html.FROM_HTML_MODE_COMPACT));
        ...
        view23.setText(android.text.Html.fromHtml("3", android.text.Html.FROM_HTML_MODE_COMPACT));
        ...
        view26.setText(android.text.Html.fromHtml("0", android.text.Html.FROM_HTML_MODE_COMPACT));
        ...
        view28.setText(android.text.Html.fromHtml("DEL", android.text.Html.FROM_HTML_MODE_COMPACT));
        ...
        view28.setBackgroundColor(Color.parseColor("#F38BA8"));
        ...
        lp_view29.setMargins(8, 8, 8, 8);
        view29.setLayoutParams(lp_view29);
        view29.setBackgroundColor(Color.parseColor("#A6E3A1"));
        view29.setTextSize(28);
    ...
    public void updateWidgetText(String id, String text) {
        if (id.equals("btn_back")) { if (this.btn_back != null) this.btn_back.setText(android.text.Html.fromHtml(text, android.text.Html.FROM_HTML_MODE_COMPACT)); return; }
    ...
    public void animateWidget(String id, String property, float to, int durationMs) {
        if (id.equals("btn_back")) { if (this.btn_back != null) ObjectAnimator.ofFloat(this.btn_back, property, to).setDuration(durationMs).start(); return; }
