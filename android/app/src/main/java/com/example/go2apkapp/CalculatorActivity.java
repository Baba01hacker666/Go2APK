...
public class CalculatorActivity extends Activity implements Go2ApkActivity {
    ...
    private View createAppView() {
        ...
        LinearLayout.LayoutParams lp_view26 = new LinearLayout.LayoutParams(0, LinearLayout.LayoutParams.WRAP_CONTENT, 2.000000f);
        lp_view26.setMargins(8, 8, 8, 8);
        view26.setLayoutParams(lp_view26);
        view26.setBackgroundColor(Color.parseColor("#A6E3A1"));
